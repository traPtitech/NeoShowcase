...
func (o *Build) GetApplication() *Application {
	if o == nil {
		return nil
	}
...
func (o *Build) GetRuntimeImage() *RuntimeImage {
	if o == nil {
		return nil
	}

	return o.R.GetRuntimeImage()
}
...
func (o *Build) GetArtifacts() ArtifactSlice {
	if o == nil {
		return nil
	}

	return o.R.GetArtifacts()
}
...
func (buildL) LoadApplication(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBuild any, mods queries.Applicator) error {
	var slice []*Build
	var object *Build
...
func (buildL) LoadRuntimeImage(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBuild any, mods queries.Applicator) error {
	var slice []*Build
	var object *Build
...
func (buildL) LoadArtifacts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBuild any, mods queries.Applicator) error {
	var slice []*Build
	var object *Build
...
func (o *Build) SetRuntimeImage(ctx context.Context, exec boil.ContextExecutor, insert bool, related *RuntimeImage) error {
	...
	if insert {
		...
		values := []any{o.ID, related.BuildID}
