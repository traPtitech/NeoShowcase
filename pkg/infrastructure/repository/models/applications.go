...
func (applicationL) LoadRepository(ctx context.Context, e boil.ContextExecutor, singular bool, maybeApplication any, mods queries.Applicator) error {
...
func (applicationL) LoadApplicationConfig(ctx context.Context, e boil.ContextExecutor, singular bool, maybeApplication any, mods queries.Applicator) error {
	var slice []*Application
	var object *Application
...
func (applicationL) LoadUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeApplication any, mods queries.Applicator) error {
	var slice []*Application
	var object *Application
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (applicationL) LoadBuilds(ctx context.Context, e boil.ContextExecutor, singular bool, maybeApplication any, mods queries.Applicator) error {
	var slice []*Application
	var object *Application
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (applicationL) LoadEnvironments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeApplication any, mods queries.Applicator) error {
	var slice []*Application
	var object *Application
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (applicationL) LoadPortPublications(ctx context.Context, e boil.ContextExecutor, singular bool, maybeApplication any, mods queries.Applicator) error {
	var slice []*Application
	var object *Application
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (applicationL) LoadWebsites(ctx context.Context, e boil.ContextExecutor, singular bool, maybeApplication any, mods queries.Applicator) error {
	var slice []*Application
	var object *Application
...
func (o *Application) SetApplicationConfig(ctx context.Context, exec boil.ContextExecutor, insert bool, related *ApplicationConfig) error {
	...
	if insert {
		...
		values := []any{o.ID, related.ApplicationID}
...
func (o *Application) AddEnvironments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Environment) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []any{o.ID, rel.ApplicationID, rel.Key}
...
func (o *Application) AddPortPublications(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*PortPublication) error {
	...
	for _, rel := range related {
		if insert {
			...
			values := []any{o.ID, rel.InternetPort, rel.Protocol}
