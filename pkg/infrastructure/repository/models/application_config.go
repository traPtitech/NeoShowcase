...
func (applicationConfigL) LoadApplication(ctx context.Context, e boil.ContextExecutor, singular bool, maybeApplicationConfig any, mods queries.Applicator) error {
...
func (o *ApplicationConfig) SetApplication(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Application) error {
	...
	values := []any{related.ID, o.ApplicationID}
