...
func (portPublicationL) LoadApplication(ctx context.Context, e boil.ContextExecutor, singular bool, maybePortPublication any, mods queries.Applicator) error {
...
func (o *PortPublication) SetApplication(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Application) error {
	...
	values := []any{related.ID, o.InternetPort, o.Protocol}
