...
func (o *Repository) GetRepositoryAuth() *RepositoryAuth {
	if o == nil {
		return nil
	}

	return o.R.GetRepositoryAuth()
}
...
func (o *Repository) GetApplications() ApplicationSlice {
	if o == nil {
		return nil
	}
...
func (o *Repository) GetUsers() UserSlice {
	if o == nil {
		return nil
	}
...
func (repositoryL) LoadRepositoryAuth(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRepository any, mods queries.Applicator) error {
...
func (repositoryL) LoadApplications(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRepository any, mods queries.Applicator) error {
	var slice []*Repository
	var object *Repository
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (repositoryL) LoadUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRepository any, mods queries.Applicator) error {
	var slice []*Repository
	var object *Repository
...
func (o *Repository) SetRepositoryAuth(ctx context.Context, exec boil.ContextExecutor, insert bool, related *RepositoryAuth) error {
	...
	if insert {
		...
		values := []any{o.ID, related.RepositoryID}
