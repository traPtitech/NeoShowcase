...
func (environmentL) LoadApplication(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEnvironment any, mods queries.Applicator) error {
...
func (o *Environment) SetApplication(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Application) error {
	...
	values := []any{related.ID, o.ApplicationID, o.Key}
