...
func (o *Artifact) GetBuild() *Build {
	if o == nil {
		return nil
	}
...
func (artifactL) LoadBuild(ctx context.Context, e boil.ContextExecutor, singular bool, maybeArtifact any, mods queries.Applicator) error {
	var slice []*Artifact
	var object *Artifact
