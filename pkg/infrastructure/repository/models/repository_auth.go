...
func (repositoryAuthL) LoadRepository(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRepositoryAuth any, mods queries.Applicator) error {
...
func (o *RepositoryAuth) SetRepository(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Repository) error {
	...
	values := []any{related.ID, o.RepositoryID}
