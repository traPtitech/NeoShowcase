...
func (o *RuntimeImage) GetBuild() *Build {
	if o == nil {
		return nil
	}
...
func (runtimeImageL) LoadBuild(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRuntimeImage any, mods queries.Applicator) error {
...
func (o *RuntimeImage) SetBuild(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Build) error {
	...
	values := []any{related.ID, o.BuildID}
