...
func TestToOne(t *testing.T) {
	...
	t.Run("BuildLogToBuildStatusUsingResultBuildStatus", testBuildLogToOneBuildStatusUsingResultBuildStatus)
...
func TestToMany(t *testing.T) {
	...
	t.Run("BuildStatusToResultBuildLogs", testBuildStatusToManyResultBuildLogs)
...
func TestToOneSet(t *testing.T) {
	...
	t.Run("BuildLogToBuildStatusUsingResultBuildLogs", testBuildLogToOneSetOpBuildStatusUsingResultBuildStatus)
...
func TestToManyAdd(t *testing.T) {
	...
	t.Run("BuildStatusToResultBuildLogs", testBuildStatusToManyAddOpResultBuildLogs)
