...
func (x *ReloadRequest) Reset() {
	*x = ReloadRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_neoshowcase_protobuf_staticsite_proto_msgTypes[0]
...
func (*ReloadRequest) Descriptor() ([]byte, []int) {
	return file_neoshowcase_protobuf_staticsite_proto_rawDescGZIP(), []int{0}
}
...
func (x *ReloadResponse) Reset() {
	*x = ReloadResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_neoshowcase_protobuf_staticsite_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReloadResponse) Descriptor() ([]byte, []int) {
	return file_neoshowcase_protobuf_staticsite_proto_rawDescGZIP(), []int{1}
}

var File_neoshowcase_protobuf_staticsite_proto protoreflect.FileDescriptor

var file_neoshowcase_protobuf_staticsite_proto_rawDesc = []byte{
	0x0a, 0x25, 0x6e, 0x65, 0x6f, 0x73, 0x68, 0x6f, 0x77, 0x63, 0x61, 0x73, 0x65, 0x2f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x69, 0x63, 0x73, 0x69, 0x74,
...
var (
	file_neoshowcase_protobuf_staticsite_proto_rawDescOnce sync.Once
	file_neoshowcase_protobuf_staticsite_proto_rawDescData = file_neoshowcase_protobuf_staticsite_proto_rawDesc
)

func file_neoshowcase_protobuf_staticsite_proto_rawDescGZIP() []byte {
	file_neoshowcase_protobuf_staticsite_proto_rawDescOnce.Do(func() {
		file_neoshowcase_protobuf_staticsite_proto_rawDescData = protoimpl.X.CompressGZIP(file_neoshowcase_protobuf_staticsite_proto_rawDescData)
	})
	return file_neoshowcase_protobuf_staticsite_proto_rawDescData
}

var file_neoshowcase_protobuf_staticsite_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_neoshowcase_protobuf_staticsite_proto_goTypes = []interface{}{
	(*ReloadRequest)(nil),  // 0: neoshowcase.protobuf.ReloadRequest
	(*ReloadResponse)(nil), // 1: neoshowcase.protobuf.ReloadResponse
}
var file_neoshowcase_protobuf_staticsite_proto_depIdxs = []int32{
...
func init() { file_neoshowcase_protobuf_staticsite_proto_init() }
func file_neoshowcase_protobuf_staticsite_proto_init() {
	if File_neoshowcase_protobuf_staticsite_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_neoshowcase_protobuf_staticsite_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_neoshowcase_protobuf_staticsite_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_neoshowcase_protobuf_staticsite_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_neoshowcase_protobuf_staticsite_proto_goTypes,
		DependencyIndexes: file_neoshowcase_protobuf_staticsite_proto_depIdxs,
		MessageInfos:      file_neoshowcase_protobuf_staticsite_proto_msgTypes,
	}.Build()
	File_neoshowcase_protobuf_staticsite_proto = out.File
	file_neoshowcase_protobuf_staticsite_proto_rawDesc = nil
	file_neoshowcase_protobuf_staticsite_proto_goTypes = nil
	file_neoshowcase_protobuf_staticsite_proto_depIdxs = nil
}
