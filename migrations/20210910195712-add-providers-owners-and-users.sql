...
CREATE TABLE `providers` (
  ...
  PRIMARY KEY (`id`)
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COMMENT = 'プロバイダテーブル';

CREATE TABLE `users` (
  `id` CHAR(36) NOT NULL COMMENT 'ユーザーID',
  `name` VARCHAR(255) NOT NULL COMMENT 'ユーザー名',
  PRIMARY KEY (`id`)
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COMMENT = 'ユーザーテーブル';
...
) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COMMENT = 'アプリケーション所有者テーブル';
