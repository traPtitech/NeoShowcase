...
func main() {
	...
	viper.SetDefault("k8s.ss.service.namespace", "default")
	viper.SetDefault("k8s.ss.service.kind", "Service")
	viper.SetDefault("k8s.ss.service.name", "")
	viper.SetDefault("k8s.ss.service.port", 80)
