...
func NewWithDocker(c2 Config) (*Server, error) {
	...
	appDeployService := usecase.NewAppDeployService(backend, applicationRepository, staticSiteServiceClient, dockerImageRegistryString, dockerImageNamePrefixString)
