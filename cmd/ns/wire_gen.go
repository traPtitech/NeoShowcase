...
func NewWithDocker(c2 Config) (*Server, error) {
	...
	appDeployService := usecase.NewAppDeployService(backend, applicationRepository, environmentRepository, staticSiteServiceClient, dockerImageRegistryString, dockerImageNamePrefixString)
