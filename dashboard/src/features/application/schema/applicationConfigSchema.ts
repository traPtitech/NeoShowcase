...
const unwrapStartupBehaviorMap: Record<
  `${AutoShutdownConfig_StartupBehavior}`,
  AutoShutdownConfig_StartupBehavior
> = {
  ...
  [AutoShutdownConfig_StartupBehavior.LOADING_PAGE]:
    AutoShutdownConfig_StartupBehavior.LOADING_PAGE,
  [AutoShutdownConfig_StartupBehavior.BLOCKING]:
    AutoShutdownConfig_StartupBehavior.BLOCKING,
} as const;
...
export type ApplicationConfigInput = v.InferInput<
  typeof applicationConfigSchema
>;

/** protobuf message -> valobot schema input */
export const configMessageToSchema = (
      ...
      (buildConfig) => ({
        ...
        value: {
          runtime: {
            ...
            autoShutdown: {
              enabled: buildConfig.value.runtimeConfig?.autoShutdown?.enabled ??
                false,
